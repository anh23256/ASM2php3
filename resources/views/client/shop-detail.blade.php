                ...
                <div class="col-lg-8 col-xl-9">
                    <div class="row g-4">
                        ...
                        <div class="col-lg-6">
                            ...
                            <h5 class="fw-bold mb-3">{{ number_format($product->price) }}VND</h5>
                            ...
                            <p class="mb-4">Do đó, Lorem Ipsum được tạo ra luôn không có sự lặp lại, không có sự hài hước
                                xen vào hoặc các từ ngữ không đặc trưng, ​​v.v.</p>
                            <p class="mb-4">Susp endisse ultricies nisi vel quam suscipit. Cá bơn đuôi kiếm; cá chó xích
                                rìu, cá chình cá ốc</p>
                    ...
                    @foreach ($relatedProducts as $relatedProduct)
                        <div class="border border-primary rounded position-relative vesitable-item">
                            <div class="vesitable-img">
                                <img src="{{ Storage::url($relatedProduct->image) }}" style="height: 250px"
                                    class="img-fluid rounded-top" alt="">
                            </div>
                            <div class="text-white bg-primary px-3 py-1 rounded position-absolute"
                                style="top: 10px; right: 10px;">{{ $category->name }}</div>
                            <div class="p-4 pb-0 rounded-bottom">
                                <h5>{{ $relatedProduct->name }}</h5>
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit sed do eiusmod te incididunt</p>
                                <div class="d-flex justify-content-between flex-lg-wrap">
                                    <p class="text-dark fw-bold">{{ number_format($relatedProduct->price) }}VND / kg</p>
                                    <a href="#"
